...
- [x] **Step 1: Add exact Python and Node dependency declarations**
...
- [x] **Step 2: Add one shared rendering exception**
...
- [x] **Step 3: Install locked dependencies without running package scripts**
...
- [x] **Step 4: Commit dependency declarations**
...
- [x] **Step 2: Run the focused test and confirm the renderer import is missing**
...
- [x] **Step 3: Implement `render_excel(report) -> bytes`**
...
- [x] **Step 5: Commit the Excel renderer**
...
- [x] **Step 1: Write a failing OOXML content test**
...
- [x] **Step 2: Run the focused test and confirm the wrapper import is missing**
...
- [x] **Step 3: Implement the Python wrapper and docx-js renderer**
...
- [x] **Step 5: Commit the DOCX renderer**
...
- [x] **Step 1: Write a failing PDF structure and text test**
...
- [x] **Step 3: Implement `render_pdf(report) -> bytes`**
...
- [x] **Step 5: Commit the PDF renderer**
...
- [x] **Step 1: Write failing CLI tests for compatibility, all formats, and rollback**
...
- [x] **Step 2: Run CLI tests and confirm `--format` is rejected**
...
- [x] **Step 3: Generalize rendering and transactional commit**
...
- [x] **Step 4: Run CLI and complete test suites**
...
- [x] **Step 5: Commit the CLI extension**
...
- [x] **Step 1: Document dependency installation and `--format all`**
...
- [x] **Step 3: Generate and structurally validate five real reports**
...
- [x] **Step 4: Render XLSX, DOCX, and PDF for visual inspection**
...
- [x] **Step 5: Commit documentation and acceptance instructions**
